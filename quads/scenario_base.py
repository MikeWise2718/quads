...
class ScenarioBase:
    ...
    def get_scenario_names():
        rv = [ "quadruped", "inverse-kinematics" ]
        return rv
    ...
    def get_scenario_desc(scenario_name):
        match scenario_name:
            case "quadruped":
                rv = "a quadruped - from Nvidia example."
            case "inverse-kinematics":
                rv = "inverse lineamatics using the Nvidia Lula API."
            case _:
    ...
    def can_handle_robot(scenario_name, robot_name):
        ...
        print(f"ScenarioBase - can_handle_robot - scenario_name:{scenario_name} robot_name:{robot_name} rv:{rv}")
        return rv
